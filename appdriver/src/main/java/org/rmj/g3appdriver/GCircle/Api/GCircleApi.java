...
public class GCircleApi extends WebApi {
    ...
    private static final String URL_SAVE_CAS_ATTACHMENT = "integsys/param/download_cas_attachments.php";
    ...
    public String getUrlSubmitMContract() {
        if(isUnitTest()){
            Log.d(TAG, "Initialize api:" + LOCAL + URL_SUBMIT_MC_CONTRACT);
            return LOCAL + URL_SUBMIT_MC_CONTRACT;
        }
        Log.d(TAG, "Initialize api:" + LIVE + URL_SUBMIT_MC_CONTRACT);
        return LIVE + URL_SUBMIT_MC_CONTRACT;
    }
    ...
    public String getUrlSaveCASAttachments() {
        if(isUnitTest()){
            Log.d(TAG, "Initialize api:" + LOCAL + URL_SAVE_CAS_ATTACHMENT);
            return LOCAL + URL_SAVE_CAS_ATTACHMENT;
        }
        Log.d(TAG, "Initialize api:" + LIVE + URL_SAVE_CAS_ATTACHMENT);
        return LIVE + URL_SAVE_CAS_ATTACHMENT;
    }
    ...
    public String getUrlDownloadGuides(){
        if(isUnitTest()) {
            Log.d(TAG, "Initialize api:" + LOCAL + URL_DOWNLOAD_GUIDES);
    ...
    public String getUrlDownloadBundles(){
        if(isUnitTest()) {
            ...
            return LOCAL + URL_DOWNLOAD_BUNDLES;
        }
    ...
    public String getUrlSubmitBranchVisit(){
        if(isUnitTest()) {
            Log.d(TAG, "Initialize api:" + LOCAL + SUBMIT_BRANCH_VISIT);
            return LOCAL + SUBMIT_BRANCH_VISIT;
        }
        Log.d(TAG, "Initialize api:" + LIVE + SUBMIT_BRANCH_VISIT);
        return LIVE + SUBMIT_BRANCH_VISIT;
    }

    public String getUrlSubmitBranchVisitSelfie(){
        if(isUnitTest()) {
            Log.d(TAG, "Initialize api:" + LOCAL + SUBMIT_BRANCH_VISIT_SELFIE);
            return LOCAL + SUBMIT_BRANCH_VISIT_SELFIE;
        }
        Log.d(TAG, "Initialize api:" + LIVE + SUBMIT_BRANCH_VISIT_SELFIE);
        return LIVE + SUBMIT_BRANCH_VISIT_SELFIE;
    }
