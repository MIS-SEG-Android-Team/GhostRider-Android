...
public class MigrationTest {
    ...
    public void TestMIgration() throws IOException {
        ...
        SupportSQLiteDatabase db = migrationTestHelper.createDatabase("GGC_ISysDBF.db", 44);
        db.close();
        ...
        GGC_GCircleDB appDB = Room.databaseBuilder(
                ...
                GGC_GCircleDB.class,
                "GGC_ISysDBF.db"
        ).addMigrations(MIGRATION_V44, MIGRATION_V45)
                .build();

        appDB.getOpenHelper().getWritableDatabase();
        appDB.close();

        Assert.assertTrue(migrationTestHelper.runMigrationsAndValidate("GGC_ISysDBF.db", 44, true, MIGRATION_V44, MIGRATION_V45).isDatabaseIntegrityOk());
    }
}
